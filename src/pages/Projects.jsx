...
const Projects = () => {
	return (
		<section className="max-container">
			...
			<p>
				I&apos;ve embarked on numerous projects over the years, but these are
				the ones I hold closest to my heart. Many of them are open-source, so if
				you find something that piques your interest, feel free to explore the
					...
					return (
						<div className="lg:w-[400px] w-full" key={index}>
							<div className="block-container w-12 h-12">
								...
								{/* <div className=" btn-back-blue btn-black rounded-xl " /> */}
